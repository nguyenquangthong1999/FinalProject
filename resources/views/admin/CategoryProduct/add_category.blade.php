...
<div class="content-wrapper">
  ...
  <div class="row">
    <div class="col-12 grid-margin stretch-card">
        <div class="card">
          <div class="card-body">
            <center><h4 class="card-title">Add New Category</h4></center>
            <form action="{{URL('add-category')}}" method="post" role="form" class="forms-sample">
                @csrf
              ...
              <div class="form-group">
                ...
                <textarea class="form-control" name="category_desc" id="exampleTextarea1" rows="5"></textarea>
              </div>
